...
InputStream get_stream(String name) {
  try
  {
...
void REAL (double[] X, int i, double v)
{
  X[2*i] = v;
}

void IMAG (double[] X, int i, double v)
{
  X[2*i + 1] = v;
}
 ...
 */
int backslash(int n, int[] Ap, int[] Ai, double[] Ax,
