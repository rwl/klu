 ...
 * @return
 */
int _dfs(int j, int k, Int32List Pinv, Int32List Llen, int Llen_offset, Int32List Lip, int Lip_offset, Int32List Stack, Int32List Flag, Int32List Lpend, int top, Float64List LU, Float64List Lik, int Lik_offset, Int32List plength, Int32List Ap_pos) {
 ...
 * @return
 */
int _lsolve_symbolic(int n, int k, Int32List Ap, Int32List Ai, Int32List Q, Int32List Pinv, Int32List Stack, Int32List Flag, Int32List Lpend, Int32List Ap_pos, Float64List LU, int lup, Int32List Llen, int Llen_offset, Int32List Lip, int Lip_offset, int k1, Int32List PSinv) {
  ...
  for (p = Ap[oldcol]; p < pend; p++) {
    ...
    if (Flag[i] != k) {
      if (Pinv[i] >= 0) {
        top = _dfs(i, k, Pinv, Llen, Llen_offset, Lip, Lip_offset, Stack, Flag, Lpend, top, LU, Lik, Lik_offset, l_length, Ap_pos);
      } else {
 ...
 * @param Offx
 */
void _construct_column(int k, Int32List Ap, Int32List Ai, Float64List Ax, Int32List Q, Float64List X, int k1, Int32List PSinv, Float64List Rs, int scale, Int32List Offp, Int32List Offi, Float64List Offx) {
  double aik;
 ...
 */
void _lsolve_numeric(Int32List Pinv, Float64List LU, Int32List Stack, Int32List Lip, int Lip_offset, int top, int n, Int32List Llen, int Llen_offset, Float64List X) {
  double xj;
  Float64List Lx;
  /*Int32List*/Float64List Li;
  int p, s, j, jnew;
  ...
  for (s = top; s < n; s++) {
    ...
    ASSERT(jnew >= 0);
    xj = X[j];
    Li = Lx = GET_POINTER(LU, Lip, Lip_offset, Llen, Llen_offset, Li_offset, Lx_offset, jnew, len);
 ...
 * @return
 */
int _lpivot(int diagrow, Int32List p_pivrow, Float64List p_pivot, Float64List p_abs_pivot, double tol, Float64List X, Float64List LU, Int32List Lip, int Lip_offset, Int32List Llen, int Llen_offset, int k, int n, Int32List Pinv, Int32List p_firstrow, KLU_common Common) {
  double x, pivot;
  Float64List Lx;
 ...
 */
void _prune(Int32List Lpend, Int32List Pinv, int k, int pivrow, Float64List LU, Int32List Uip, int Uip_offset, Int32List Lip, int Lip_offset, Int32List Ulen, int Ulen_offset, Int32List Llen, int Llen_offset) {
  double x;
  Float64List Lx;
  ...
  Ui = GET_POINTER(LU, Uip, Uip_offset, Ulen, Ulen_offset, Ui_offset, Ux_offset, k, ulen);
  for (p = 0; p < ulen[0]; p++) {
 ...
 */
int _kernel(int n, Int32List Ap, Int32List Ai, Float64List Ax, Int32List Q, int lusize, Int32List Pinv, Int32List P, List<Float64List> p_LU, Float64List Udiag, int Udiag_offset, Int32List Llen, int Llen_offset, Int32List Ulen, int Ulen_offset, Int32List Lip, int Lip_offset, Int32List Uip, int Uip_offset, Int32List lnz, Int32List unz, Float64List X, Int32List Stack, Int32List Flag, Int32List Ap_pos, Int32List Lpend, int k1, Int32List PSinv, Float64List Rs, Int32List Offp, Int32List Offi, Float64List Offx, KLU_common Common) {
  ...
  for (k = 0; k < n; k++) {
    ...
    top = _lsolve_symbolic(n, k, Ap, Ai, Q, Pinv, Stack, Flag, Lpend, Ap_pos, LU, lup, Llen, Llen_offset, Lip, Lip_offset, k1, PSinv);
