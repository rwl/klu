...
class KLU_numeric
{
	...
	Int32List Uip;         /* size n. pointers into LUbx[block] for U */
	Int32List Llen;        /* size n. Llen [k] = # of entries in kth column of L */
	Int32List Ulen;        /* size n. Ulen [k] = # of entries in kth column of U */
  List<Float64List> LUbx;     /* L and U indices and entries (excl. diagonal of U) */  // FIXME: indices are doubles and cast to integers
